...
public class BaseComputerMenu extends AbstractContainerMenu {
    public final BaseComputerBlockEntity blockEntity;
    private final Level level;
    private final ContainerData data;

    public BaseComputerMenu(int id, Inventory inv, FriendlyByteBuf buf) {
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()), player, ModBlocks.BASE_COMP.get());
    }
